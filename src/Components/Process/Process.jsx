  ...
  return (
    <div className="processContainer">
      ...
      >
        <g id="processGraph">
          ...
          <g id="Group 20">
            <circle
              ...
              strokeDasharray="15 15"
            />
            <circle id="Ellipse 10_2" cx="61" cy="748" r="43" fill="#FFDE67" />
          </g>
          <g id="Group 21">
            <circle
              id="Ellipse 7_3"
              ...
              strokeDasharray="15 15"
            />
            <circle id="Ellipse 10_3" cx="356" cy="426" r="43" fill="#FFDE67" />
          </g>
          <g id="Group 22">
            <circle
              id="Ellipse 7_4"
              ...
              strokeDasharray="15 15"
            />
            <circle id="Ellipse 10_4" cx="941" cy="449" r="43" fill="#FFDE67" />
          </g>
          <g id="Group 23">
            <circle
              id="Ellipse 7_5"
              ...
              strokeDasharray="15 15"
            />
            <circle id="Ellipse 10_5" cx="938" cy="120" r="43" fill="#FFDE67" />
          </g>
        </g>
        <foreignObject
          x="-10"
        ...
        >
          <div id="context_1">
            <h3 style={{ fontSize: "2rem", textAlign: "left" }}>03/22-09/22</h3>
            <ul
              style={{
                listStyle: "inside",
                fontSize: "1.5em",
        ...
        >
          <div id="context_2">
            <h3 style={{ fontSize: "2rem", textAlign: "left" }}>10/22-12/22</h3>
            <ul
              style={{
                listStyle: "inside",
                fontSize: "1.5em",
        ...
        >
          <div id="context_3">
            <h3 style={{ fontSize: "2rem", textAlign: "left" }}>01/23-01/24</h3>
            <ul
              style={{
                listStyle: "inside",
                fontSize: "1.5em",
